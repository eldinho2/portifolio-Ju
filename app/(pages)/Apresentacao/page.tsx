...
const Apresentação = () => {
  return (
    <main className='flex flex-col justify-center items-center mt-10 md:mt-3'>
        <h1 className='text-8xl font-play py-3 font-bold md:text-4xl'>
          Apresentação
        </h1>
        <div className='relative z-50 mb-[100px]'>
          <div className='bg-[#B8CDDB] max-w-4xl p-4 rounded-xl font-mon font-semibold md:max-w-sm'>
          ...
          <div className='absolute top-[-126px] left-[-11px] -z-30 md:top-[-72px]'>
            <Image

    ...
    <main className="flex justify-evenly items-center flex-col mt-10 md:mt-3 md:p-10 md:mb-11 mb-11">
      <div className="flex flex-col max-w-xl">
        ...
        <p className="mt-4 text-xl font-mon font-semibold">
          ...
          dolores placeat quos culpa amet enim ipsa neque. Lorem ipsum dolor sit
          amet consectetur adipisicing elit. Non, alias ex blanditiis impedit
          totam saepe aspernatur cum reprehenderit! Consequatur reprehenderit
          nesciunt vitae culpa dolorem. Labore culpa repellendus nostrum
          voluptates deserunt. Lorem ipsum dolor sit amet consectetur
          adipisicing elit. Debitis id nemo libero mollitia, in repudiandae
          dolorum odio ea quae voluptas esse sequi culpa, illo optio laborum
          consequatur. Voluptate, in provident.
        </p>
      </div>
      <div className="flex flex-col justify-center items-center max-w-xl">
        ...
        <p className="text-xl font-mon font-semibold">
          ...
          sapiente ratione maiores suscipit rem excepturi ut amet sed tempora
          non? Excepturi vero officiis aliquid amet, necessitatibus maiores ut
          assumenda corrupti!
        </p>
      </div>
    </main>

  ...
  return (
    <main className="flex justify-evenly items-center flex-col mt-10 md:mt-3 md:p-10 md:mb-11 mb-11">
      ...
      <div className="flex flex-col justify-center items-center max-w-5xl">
        ...
        <p className="mt-4 text-xl font-mon font-semibold sm:text-lg sm:p-2 text-left sm:text-center">
          Já a matemática problematizada é uma abordagem de ensino que vai além
          da visão tradicional de uma disciplina &ldquo;exata e
          inquestionável&rdquo;. Em vez de focar apenas em fórmulas e
          procedimentos, essa metodologia busca envolver os alunos em situações
          desafiadoras, nas quais eles são estimulados a questionar, explorar e
          resolver problemas de forma ativa. O cerne dessa abordagem reside na
          desconstrução da ideia de que a matemática é um conjunto de regras
          imutáveis, promovendo a compreensão dos conceitos por meio da
          resolução de desafios contextualizados. A matemática problematizadora
          não apenas ensina os conceitos matemáticos, mas também desenvolve
          habilidades críticas, criativas e autônomas nos alunos, preparando-os
          para enfrentar problemas do mundo real com confiança e compreensão
          mais profunda.
        </p>
        <h1 className="text-center my-4 text-4xl font-play font-bold md:text-4xl sm:text-2xl">

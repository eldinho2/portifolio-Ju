            ...
            <div>
              ...
              <div className="bg-[#B8CDDB] p-6 w-64 rounded-xl">
                ...
                <p>
                  ...
                  Magni, rem harum asperiores eveniet quo deleniti, modi
                  sapiente beatae dolore ducimus incidunt dolor expedita.
                  Consequatur, eaque? Id voluptatum ipsam alias earum.
                </p>
              </div>
            </div>
            <div>

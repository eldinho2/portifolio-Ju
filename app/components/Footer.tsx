...
const Footer = () => {
    ...
    return (
        <footer ref={referencia} className="bg-[#6C99B6] max-h-24 flex justify-evenly items-center fixed bottom-0 left-0 right-0 z-[100] mx-auto transition-all ease-in-out duration-500">
            <div className="mb-3">
